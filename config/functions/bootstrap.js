...
async function createSuperUser() {
  ...
  const params = {
    username: process.env.SUPERUSER_USERNAME || "roicoroy",
    password: process.env.SUPERUSER_PASSWORD || "Rwbento123!",
    firstname: process.env.SUPERUSER_FIRSTNAME || "Ricardo",
    lastname: process.env.SUPERUSER_LASTNAME || "Bento",
    email: process.env.SUPERUSER_EMAIL || "roicoroy@yahoo.com.br",
    blocked: false,
    isActive: true,
  }
...
async function createMedusaUser(medusaRoleId) {
  const params = {
    username: process.env.MEDUSA_USER_USERNAME || "roicoroy",
    password: process.env.MEDUSA_USER_PASSWORD || "Rwbento123!",
    email: process.env.MEDUSA_USER_EMAIL || "roicoroy@yahoo.com.br",
    role: medusaRoleId,
    confirmed: true,
    blocked: false,
    provider: "local",
